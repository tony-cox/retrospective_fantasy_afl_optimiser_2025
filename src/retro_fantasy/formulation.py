...
def _create_captain_decision_variables(
    ...
    """Create captain decision variables c[p, r]."""
...
def _create_scored_decision_variables(
    ...
    """Create scored decision variables s[p, r] (used for best-N scoring rounds)."""
